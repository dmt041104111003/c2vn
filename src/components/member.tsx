...
export default function Member({
  ...
  return (
    <div className="group relative">
      ...
      ></div>
      <div
        className={`relative aspect-[3/4] overflow-hidden rounded-sm border border-white/20 bg-gray-900 shadow-2xl transition-all duration-500 hover:shadow-${color}-500/10`}
      >
        <Image
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-6">
          <div className="space-y-3">
            ...
            <p className={`text-sm font-semibold text-${color}-100`}>{role}</p>
